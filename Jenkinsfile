...
pipeline {
    ...
    environment {
        author_name = "Adrian Grupp, Valentin Kozlov"
        author_email = "usmfz@student.kit.edu"
        app_name = "tf_cnn_benchmarks"
        job_location = "Pipeline-as-code/DEEP-OC-org/DEEP-OC-tf_cnn_benchmarks/${env.BRANCH_NAME}"
    }
